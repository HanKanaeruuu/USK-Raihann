...
<body>
    <div class="container">
        <h1 class="text-center">Admin Transaksi</h1>
        <p class="lead text-center">Transaksi Dari Siswa</p>
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <div>
                <a href="{{ route('admin.transactions.print') }}" class="btn btn-primary" target="_blank">
        ...
        <div class="search-bar text-center">
            <input type="text" id="searchTransaction" class="form-control" placeholder="Search transactions..." onkeyup="searchTransactions()">
        </div>
