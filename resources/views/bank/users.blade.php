...
<body>
    ...
    <td>
        <a href="{{ route('bankmini.users.edit', $user->id) }}" class="btn btn-sm btn-warning">
            <i class="bi bi-pencil-square"></i>
        </a>
        <form action="{{ route('bankmini.users.destroy', $user->id) }}" method="POST" style="display:inline-block;" onsubmit="return confirm('Yakin ingin menghapus pengguna ini?');">
            @csrf
            @method('DELETE')
...
@endforeach
        ...
        <div class="user-form">
            ...
            <form action="{{ route('bankmini.users.store') }}" method="POST">
                @csrf
                <div class="mb-3">
